        ...
        self._writer.writerow(
            {
                ...
                "w": bbox[2],
                "h": bbox[3],
                "class_id": "" if state.class_id is None else state.class_id,
                "class_label": "" if state.class_label is None else state.class_label,
                "semantic_label": "" if state.semantic_label is None else state.semantic_label,
